...
@NgModule({
  declarations: [AdminPageComponent, BooksListComponent, DashBoardComponent, HeaderComponent, SideNavComponent, FooterComponent, BookInsertionComponent, ScienceComponent, KidsComponent, HistoryComponent, RomanticComponent, NewUserComponent, UpdateUserComponent, UserComponent, UpdateBookComponent, IssuingBookComponent, ReturnsComponent, CategoriesComponent, UsersComponent, BookCopiesComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
    // HeaderComponent,
